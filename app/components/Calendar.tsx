...
const CROP_USAGE_DETAILS: Record<string, { badge: string; stage: string; formula: string; rate: string }[]> = {
  "กาแฟ": [
    { badge: "ก่อนปลูก", stage: "เตรียมดิน", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "50-100 กรัม/ต้น" },
  ...
  "ทุเรียน (ยังไม่ให้ผลผลิต) 0-1 ปี": [
    { badge: "อายุ 0-1 ปี", stage: "เตรียมดินก่อนปลูก", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "50-100 กรัม/ต้น" },
    { badge: "อายุ 0-1 ปี", stage: "ต้นตั้งตัว", formula: "ปุ๋ยอินทรีย์เคมี 6-3-3", rate: "50-100 กรัม/ต้น" },
    { badge: "อายุ 1-2 ปี", stage: "เตรียมดิน", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "100-200 กรัม/ต้น" },
    { badge: "อายุ 1-2 ปี", stage: "เร่งต้น บำรุงใบ", formula: "ปุ๋ยอินทรีย์เคมี 6-3-3", rate: "100-200 กรัม/ต้น" },
  ],
  "ทุเรียน (ยังไม่ให้ผลผลิต) 2-3 ปี": [
    { badge: "อายุ 2-3 ปี", stage: "ปรับดิน", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "200-300 กรัม/ต้น" },
    { badge: "อายุ 2-3 ปี", stage: "บำรุงใบขยายทรงพุ่ม", formula: "ปุ๋ยอินทรีย์เคมี 6-3-3", rate: "300-500 กรัม/ต้น" },
    { badge: "อายุ 3-4 ปี", stage: "ปรับดิน", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "100-200 กรัม/ต้น" },
    { badge: "อายุ 3-4 ปี", stage: "เร่งต้น บำรุงใบ ขยายทรงพุ่ม", formula: "ปุ๋ยอินทรีย์เคมี 12-3-5", rate: "100-200 กรัม/ต้น" },
  ],
  "ทุเรียน (ให้ผลผลิต)": [
    { badge: "หลังเก็บเกี่ยว", stage: "ฟื้นฟูสภาพต้น บำรุงดิน", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "1-2 กก./ต้น" },
  ...
  "ปาล์มน้ำมัน เริ่มปลูก": [
    { badge: "ก่อนปลูก", stage: "เตรียมดินก่อนปลูก", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "100-200 กรัม/ต้น" },
  ...
  "ยาสูบ": [
    { badge: "ก่อนปลูก", stage: "เตรียมดินก่อนปลูก", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "50 กก./ไร่" },
  ...
  "ยางพาราเริ่มปลูก": [
    { badge: "ก่อนปลูก", stage: "เตรียมดินก่อนปลูก", formula: "ปุ๋ยอินทรีย์ผง OM 25 % และ ปุ๋ยอินทรีย์เม็ด OM 20 %", rate: "50-100 กรัม/ต้น" },
