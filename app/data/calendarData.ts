...
export const CROP_USAGE_DETAILS: Record<string, UsageDetail[]> = {
  ...
  "ทุเรียน (ยังไม่ให้ผลผลิต) 2-3 ปี": [
    { badge: "อายุ 2-3 ปี", stage: "ปรับดิน",                    formula: "OM 25% หรือ OM 20%", rate: "300-500 กรัม/ต้น" },
    { badge: "อายุ 2-3 ปี", stage: "บำรุงใบขยายทรงพุ่ม",         formula: "6-3-3",             rate: "300-500 กรัม/ต้น" },
    { badge: "อายุ 3-4 ปี", stage: "ปรับดิน",                    formula: "OM 25% หรือ OM 20%", rate: "100-200 กรัม/ต้น" },
    { badge: "อายุ 3-4 ปี", stage: "เร่งต้น บำรุงใบ ขยายพุ่ม",  formula: "12-3-5",            rate: "500-1000 กรัม/ต้น" },
  ],
  "ทุเรียน (ให้ผลผลิต)": [
